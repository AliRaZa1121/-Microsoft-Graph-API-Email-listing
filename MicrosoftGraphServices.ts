...
export class MicrosoftGraphServices {
    ...
    private static REDIRECT_URI: string = process.env.REDIRECT_URI || "http://localhost/test_imap"; // Change as needed
    ...
    public async getAuthenticationCodes(code: string): Promise<any> {
        try {
            const response = await axios.post('https://login.microsoftonline.com/24b5276e-14d8-4880-a934-a57630d24fa5/oauth2/v2.0/token', {
